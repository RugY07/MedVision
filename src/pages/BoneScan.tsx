        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <h1 className="text-5xl font-bold mb-4">
              <span className="glow-text">Bone Scan Analysis</span>
            </h1>
            <p className="text-muted-foreground text-lg">
              Advanced AI diagnostics for skeletal imaging and bone scans
            </p>
          </motion.div>
        </div>
      </section>

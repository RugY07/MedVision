...
const BrainScan = () => {
  const { analysisResults, isAnalyzing, handleFileSelect, handleNewScan } = useAnalyzeScan("Brain");
        ...
        <div className="container mx-auto max-w-6xl">
          ...
          >
            <h1 className="text-5xl font-bold mb-4">
              <span className="glow-text">Brain Scan Analysis</span>
            </h1>
            <p className="text-muted-foreground text-lg">
              Advanced neural network diagnostics for brain MRI, CT, and X-ray scans
            </p>
          </motion.div>
        </div>
      </section>
